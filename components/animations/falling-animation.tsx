...
export function FallingAnimation({
	...
	return (
		<div className="relative h-full w-full overflow-hidden">
			...
			{/* 아이템들 */}
			<AnimatePresence>{revealed && items}</AnimatePresence>
			...
			>
				<motion.div
					className={`text-7xl sm:text-9xl text-center font-bold ${gender === "boy" ? "text-baby-blue-dark" : "text-baby-pink-dark"} drop-shadow-lg`}
