...
export function FireworksAnimation({ gender, revealed, onComplete }: FireworksAnimationProps) {
  ...
  return (
    <div ref={containerRef} className="relative h-full w-full overflow-hidden bg-gray-900">
      ...
      >
        <motion.div 
          className={`text-7xl sm:text-9xl font-bold ${gender === 'boy' ? 'text-baby-blue' : 'text-baby-pink'} drop-shadow-md`}
