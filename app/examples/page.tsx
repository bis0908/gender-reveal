...
const examples = [
	{
		...
		description:
			"파란색 색종이가 폭발하는 효과와 함께 귀여운 남자아이 Gender reveal",
	},
	{
		id: "example2",
		motherName: "소연",
		...
		description:
			"분홍색 풍선이 하늘로 날아오르는 효과와 함께하는 여자아이 Gender reveal",
	},
	{
		id: "example3",
		motherName: "지은",
	...
	},
	{
		...
		description:
			"분홍색 작은 아기 용품들이 내려오는 사랑스러운 여자아이 Gender reveal",
	},
];
					...
					<div className="container mx-auto max-w-6xl">
						<div className="text-center space-y-4">
							...
							<p className="text-gray-600 max-w-2xl mx-auto">
								다른 부모님들이 만든 Gender Reveal 예시를 확인하고 영감을
								얻어보세요. 아래 예시들은 다양한 애니메이션과 스타일을
								보여줍니다.
							</p>
						</div>
					</div>
								...
								<Card key={example.id} className="overflow-hidden card-hover">
									...
									<CardContent className="p-6">
										<h2 className="text-xl font-semibold mb-2">
											{example.motherName} & {example.fatherName}의 Gender
											Reveal
										</h2>
										<p className="text-gray-500 mb-4 text-sm">
											아기 {example.babyName} •{" "}
											{example.gender === "boy" ? "남자아이" : "여자아이"} •{" "}
											{example.animationType === "confetti"
												? "색종이"
												: example.animationType === "balloons"
													? "풍선"
													: example.animationType === "fireworks"
														? "불꽃놀이"
														: "떨어지는 아이템"}
										</p>
				...
				<section className="py-16 px-4 sm:px-6 bg-gray-50">
					<div className="container mx-auto max-w-4xl text-center">
						<h2 className="text-2xl sm:text-3xl font-bold mb-4">
							나만의 Gender Reveal 만들기
						</h2>
						<p className="text-gray-600 mb-8 max-w-2xl mx-auto">
							몇 분 안에 나만의 특별한 Gender Reveal을 만들고 전 세계 어디에서나
							사랑하는 가족, 친구들과 함께 이 특별한 순간을 공유해보세요.
						</p>
